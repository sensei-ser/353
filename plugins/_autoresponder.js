...
const triggerWords = /\b(bot|simi|alexa|Horus)\b/i;
...
if (!systemPrompt) {
systemPrompt = await fetch('https://raw.githubusercontent.com/elrebelde21/Horus-MD/main/src/text-chatgpt.txt').then(v => v.text());
